...
## Nomal Dijkstra's Algorithm Implementation in C++ with detailed comments
...
void dijkstra(int start, const vector<vector<Edge>>& graph, int T) {// T is the threshold for edge weight increase
